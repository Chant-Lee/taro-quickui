...
$app_define$('@app-component/taro-progress', [], function($app_require$, $app_exports$, $app_module$){
     $app_script$($app_module$, $app_exports$, $app_require$)
     if ($app_exports$.__esModule && $app_exports$.default) {
            $app_module$.exports = $app_exports$.default
        }
  ...
  "children": [
    {
      ...
      "classList": function () {return ['taro_progress_info', this.className]},
    ...
    },
    {
      ...
      "shown": function () {return this.showInfo}
    }
  ]
}
...
exports.default = {
  ...
  onInit: function onInit() {
    this.progressStyle = Object.assign(this.style, { 'background': this.backgroundColor,
      'color:': this.activeColor, 'stroke-width:': this.strokeWidth });
  },
