...
$app_define$('@app-component/taro-button', [], function($app_require$, $app_exports$, $app_module$){
     $app_script$($app_module$, $app_exports$, $app_require$)
     if ($app_exports$.__esModule && $app_exports$.default) {
            $app_module$.exports = $app_exports$.default
        }
...
module.exports = {
  ...
  "classList": function () {return ['taro_button', this.className, 'btn_size_' + (this.size), 'btn_color_' + (this.type)]},
  ...
  "children": [
    {
      ...
      "attr": {
        ...
        "src": function () {return this.loadingImg}
      },
      "classList": [
        "taro_btn_loading"
      ]
