...
$app_define$('@app-component/taro-camera', [], function($app_require$, $app_exports$, $app_module$){
     $app_script$($app_module$, $app_exports$, $app_require$)
     if ($app_exports$.__esModule && $app_exports$.default) {
            $app_module$.exports = $app_exports$.default
        }
...
module.exports = {
  ...
  "classList": function () {return ['camera', this.className]},
  "id": function () {return this.id},
  "children": [
    {
      "type": "input",
    ...
    },
    {
      "type": "image",
      "attr": {
        "src": function () {return this.photoUrl}
      },
      "classList": [
        "image"
      ]
